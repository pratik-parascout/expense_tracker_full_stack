...
document.addEventListener('DOMContentLoaded', function () {
  ...
  axios
    .get('http://localhost:3000/expense/isPremium', {
...
function buyPremium() {
  ...
  axios
    .post(
      'http://localhost:3000/expense/create-premium-order',
      {},
      {
        headers: { Authorization: token },
      }
    ...
    .then((response) => {
      ...
      const options = {
        ...
        handler: function (response) {
          axios
            .post(
              'http://localhost:3000/expense/payment-success',
              {
...
function fetchExpenses(page = 1) {
  ...
  axios
    .get(
      `http://localhost:3000/expense/expenses?page=${page}&limit=${itemsPerPage}`,
      {
        headers: { Authorization: token },
      }
    )
